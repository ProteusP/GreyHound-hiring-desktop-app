...
class Responces
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//candidate_id,vacancy_id
     ...
     */
    explicit Responces(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Responces(const Json::Value &pJson) noexcept(false);
     ...
     */
    Responces(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Responces>;
    friend drogon::orm::BaseBuilder<Responces, true, true>;
    friend drogon::orm::BaseBuilder<Responces, true, false>;
    friend drogon::orm::BaseBuilder<Responces, false, true>;
    friend drogon::orm::BaseBuilder<Responces, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Responces>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where candidate_id = ? and vacancy_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where candidate_id = ? and vacancy_id = ?";
        return sql;
    }
