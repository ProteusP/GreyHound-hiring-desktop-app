...
class Vacancies
{
  public:
     ...
     */
    explicit Vacancies(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Vacancies(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    ///Get the value of the column educ_place, returns the default value if the column is null
    ...
    ///Get the value of the column remoteness_status_id, returns the default value if the column is null
