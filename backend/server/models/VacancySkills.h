...
class VacancySkills {
  public:
     ...
     */
    explicit VacancySkills(const drogon::orm::Row &r,
    ...
    /**  For column skill_id  */
    /// Get the value of the column skill_id, returns the default value if the
    /// column is null
  ...
  public:
    static const std::string &sqlForFindingByPrimaryKey() {
        static const std::string sql = "select * from " + tableName +
                                       " where vacancy_id = ? and skill_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey() {
        static const std::string sql = "delete from " + tableName +
                                       " where vacancy_id = ? and skill_id = ?";
        return sql;
    }
