...
EducStatuses::EducStatuses(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
void EducStatuses::updateByMasqueradedJson(const Json::Value &pJson,
...
const typename EducStatuses::PrimaryKeyType & EducStatuses::getPrimaryKey() const
{
    assert(id_);
    return *id_;
}
...
bool EducStatuses::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool EducStatuses::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool EducStatuses::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool EducStatuses::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                    const std::vector<std::string> &pMasqueradingVector,
                                                    std::string &err)
{
    if(pMasqueradingVector.size() != 2)
...
bool EducStatuses::validJsonOfField(size_t index,
