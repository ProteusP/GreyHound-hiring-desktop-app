...
const std::vector<std::string> CandidatesSkills::primaryKeyName = {"candidate_id","skill_id"};
const bool CandidatesSkills::hasPrimaryKey = true;
const std::string CandidatesSkills::tableName = "candidates_skills";

const std::vector<typename CandidatesSkills::MetaData> CandidatesSkills::metaData_={
{"candidate_id","int32_t","int",4,0,1,1},
{"skill_id","int32_t","int",4,0,1,1}
};
const std::string &CandidatesSkills::getColumnName(size_t index) noexcept(false)
{
    assert(index < metaData_.size());
    return metaData_[index].colName_;
}
CandidatesSkills::CandidatesSkills(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
...
CandidatesSkills::CandidatesSkills(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
void CandidatesSkills::updateByMasqueradedJson(const Json::Value &pJson,
...
const std::shared_ptr<int32_t> &CandidatesSkills::getCandidateId() const noexcept
{
    return candidateId_;
}
...
typename CandidatesSkills::PrimaryKeyType CandidatesSkills::getPrimaryKey() const
{
...
void CandidatesSkills::outputArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getCandidateId())
...
void CandidatesSkills::updateArgs(drogon::orm::internal::SqlBinder &binder) const
{
    if(dirtyFlag_[0])
    {
        if(getCandidateId())
...
bool CandidatesSkills::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("candidate_id"))
    {
...
bool CandidatesSkills::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool CandidatesSkills::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("candidate_id"))
    {
...
bool CandidatesSkills::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                        const std::vector<std::string> &pMasqueradingVector,
                                                        std::string &err)
{
    if(pMasqueradingVector.size() != 2)
