...
const std::shared_ptr<::trantor::Date> &Responces::getCreatedAt() const noexcept
{
    return createdAt_;
}
...
bool Responces::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("candidate_id"))
    {
...
bool Responces::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Responces::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("candidate_id"))
    {
...
bool Responces::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                 const std::vector<std::string> &pMasqueradingVector,
                                                 std::string &err)
{
    if(pMasqueradingVector.size() != 4)
...
bool Responces::validJsonOfField(size_t index,
