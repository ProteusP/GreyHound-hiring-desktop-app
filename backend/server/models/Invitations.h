...
class Invitations
{
  public:
     ...
     */
    explicit Invitations(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Invitations(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
