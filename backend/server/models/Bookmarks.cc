...
const std::vector<std::string> Bookmarks::primaryKeyName = {"candidate_id",
                                                            "vacancy_id"};
...
void Bookmarks::updateByMasqueradedJson(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false) {
    if (pMasqueradingVector.size() != 2) {
        LOG_ERROR << "Bad masquerading vector";
...
const std::vector<std::string> &Bookmarks::insertColumns() noexcept {
    static const std::vector<std::string> inCols = {"candidate_id",
                                                    "vacancy_id"};
    return inCols;
}
...
bool Bookmarks::validateJsonForCreation(const Json::Value &pJson,
                                        std::string &err) {
    if (pJson.isMember("candidate_id")) {
...
bool Bookmarks::validateMasqueradedJsonForCreation(
    const Json::Value &pJson,
...
bool Bookmarks::validateJsonForUpdate(const Json::Value &pJson,
                                      std::string &err) {
    if (pJson.isMember("candidate_id")) {
        if (!validJsonOfField(0, "candidate_id", pJson["candidate_id"], err,
                              false))
...
bool Bookmarks::validateMasqueradedJsonForUpdate(
    const Json::Value &pJson,
    const std::vector<std::string> &pMasqueradingVector, std::string &err) {
    if (pMasqueradingVector.size() != 2) {
        err = "Bad masquerading vector";
...
bool Bookmarks::validJsonOfField(size_t index, const std::string &fieldName,
