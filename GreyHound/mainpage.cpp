...
MainPage::MainPage(QWidget *parent) : QWidget(parent), ui(new Ui::MainPage) {
    ...
    flowLayout->addWidget(new VacancyCard(
        "senior developer python", "ноунейм1", "топ вакансия мильон в сутки"
    ));
    flowLayout->addWidget(new VacancyCard(
        "senior developer c++", "ноунейм2", "топ вакансия мильон в сутки"
    ));
    flowLayout->addWidget(new VacancyCard(
        "senior developer go", "ноунейм3", "топ вакансия мильон в сутки"
    ));
    flowLayout->addWidget(new VacancyCard(
        "senior developer assembler", "ноунейм4", "топ вакансия мильон в сутки"
    ));
    flowLayout->addWidget(new VacancyCard(
        "senior developer pascal", "ноунейм5", "топ вакансия мильон в сутки"
    ));
