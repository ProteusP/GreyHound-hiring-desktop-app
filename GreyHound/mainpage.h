...
class MainPage : public QWidget {
  ...
  public:
    explicit MainPage(QNetworkAccessManager *manager,
    ...
    QWidget *
    createCandidatesPageWithFilters(const QMap<QString, QVariant> &filters);
    QWidget *
    createVacanciesPageWithFilters(const QMap<QString, QVariant> &filters);
  ...
  private:
    ...
    void addFormField(QLayout *layout, const QString &fieldName,
                      const QString &fieldValue, const QString &fieldStyle = "",
